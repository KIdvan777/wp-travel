<?php
add_action( 'init', 'register_post_type_best' ); // Использовать функцию только внутри хука init

function register_post_type_best() {
	$labels = array(
		'name' => 'Туры',
		...
		'menu_name' => 'Лучшие туры' // ссылка в меню в админке
	);
	$args = array(
		'labels' => $labels,
		'public' => true,
		...
		'taxonomies' => array('best'),
		'rewrite' => array(
			'slug' => 'best' // Текст в ЧПУ. По умолчанию: название таксономии.
...
add_action( 'init', 'add_new_taxonomies_best', 0 );