...
function register_post_type_services() {
	...
	$args = array(
		...
		'rewrite' => array(
			'slug' => 'post_services' // Текст в ЧПУ. По умолчанию: название таксономии.
...
add_action( 'init', 'add_new_taxonomies_taxserv', 0 );