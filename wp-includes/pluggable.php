 ...
 * @param string $default    Optional. URL for the default image or a default type. Accepts '404.php'
 *                           (return a 404.php instead of a default image), 'retro' (8bit), 'monsterid'
...
function get_avatar( $id_or_email, $size = 96, $default = '', $alt = '', $args = null ) {
	 ...
	 * @param string $default     URL for the default image or a default type. Accepts '404.php', 'retro', 'monsterid',
